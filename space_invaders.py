...
spaceship_img = pygame.image.load("Nostaliga/spaceship.png")
alien_img = pygame.image.load("Nostaliga/alien.png")
bullet_img = pygame.image.load("Nostaliga/bullet.png")
